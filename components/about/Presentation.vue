...
<template>
  <div id="home" class="md:h-screen flex flex-col md:flex-row">
    <div class="md:h-screen md:order-last">
      <div class="h-full flex flex-col justify-center items-end pt-16">
        <div class="px-16 small-text text-justify pb-16 md:pb-2">
          <p class="about-paragraph">
            <span class="red"
              >I started using a computer when I was 4 years old
            </span>
            (it helps that my 2 parents were Software Engineers at the time). I
            liked to play games and most of all online mini-games where you had
            to come back every day to make progress. You usually had a profile
            that you could tweak if you knew how to edit the source code, and
            that's why
            <span class="bold">
          ...
          <p class="about-paragraph">
            ...
            through a "prepa" (French preparatory classes for Engineering
            Schools) and got into Telecom SudParis, an Engineering school known
            for being tech-oriented. There,
            ...
            <span class="bold"> I honed my technical skills </span> to be able
            to apply to the most prestigious tech companies. ✨
          </p>
          <p class="about-paragraph">
            <span class="red"
